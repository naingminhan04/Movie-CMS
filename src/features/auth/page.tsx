...
const AuthPage = () => {
  ...
  return (
    <main className="flex h-220 bg-[#232B73] relative overflow-hidden">
      ...
      {/* Right Side */}
      <section
        className={`flex absolute transition-all duration-500 h-full w-[42%] min-w-150 items-center justify-center rounded-l-[56px] bg-white ${isLoaded ? "right-0" : "-right-160"}`}
      >
        <div className="w-full max-w-130 px-12">
